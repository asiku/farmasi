 ...
 * @author jengcool
 */
public class frm_login_poli_keu extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_login_poli_keu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
